...
namespace Infrastructure.Repository.Fraude
{
    ...
    public class RepositoryFraude : IFraudeRepository, IDisposable //nome da interface//
    {
        ...
        public async Task Adcionar(Domain.Entities.Fraude Objeto)
        {
        ...
        public async Task Atualizar(Domain.Entities.Fraude Objeto)
        {
            using (var banco = new Context(_OptionsBuilder))
            {
        ...
        public async Task Excluir(Domain.Entities.Fraude Objeto)
        {
            using (var banco = new Context(_OptionsBuilder))
            {
        ...
        public async Task<List<Domain.Entities.Fraude>> Listar()
        {
            using (var banco = new Context(_OptionsBuilder))
            {
                return await banco.Set<Domain.Entities.Fraude>().AsNoTracking().ToListAsync();
            }
        }

        public async Task<Domain.Entities.Fraude> ObterPorId(int Id)
        {
            using (var banco = new Context(_OptionsBuilder))
            {
                return await banco.Set<Domain.Entities.Fraude>().FindAsync(Id);
            }
        }
        public void Dispose()
        {
